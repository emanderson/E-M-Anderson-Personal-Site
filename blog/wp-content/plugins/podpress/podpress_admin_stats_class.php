	...
	function settings_stats_edit() {
		...
		Switch($show_this_page) {
			case 'botdb_list':
				...
				echo '			</table>'."\n";				
				echo '			<p class="submit"> '."\n";
				echo '				<input type="submit" name="Submit" value="'.__('Remove elements', 'podpress').' &raquo;" /><br />'."\n";
				echo '			</p> '."\n";
			...
			case 'botdb_mark_bots':
				...
				echo '				<p class="submit"> '."\n";
				echo '					<input type="submit" name="Submit" value="'.__('Update Options', 'podpress').' &raquo;" /><br />'."\n";
				echo '				</p> '."\n";
				echo '				<input type="hidden" name="podPress_submitted" value="botdb" />'."\n";
				echo '			</form>'."\n";
				echo '		</fieldset>'."\n";
